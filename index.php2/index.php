...
<div class="container ">
		...
		<a href="../index.php1/"><img src="logo/logoA.SVG" class="img-fluid"></a>
</div>
		...
		<input type="button" class="col-auto bg-dark text-white rounded mx-2" onClick="location.href='http://localhost/php-Egitim/index.php1/'" value="Gelirler" /></a>
</div>
     	<div class="col-auto text-white rounded mx-2">
		<a href="#" class="text-white">
			<input type="button" class="col-auto bg-dark text-white rounded mx-2" onClick="location.href='http://localhost/php-Egitim/index.php2/'" value="Giderler" /></a>
</div>	
</div>
</div>
</div>
	...
	<form  action="islem.php" method="POST">
		...
		<input type="datetime-local" name="dersane_Zaman">
	...
	<table class="table table-dark " style="width: 80%" border="1">
		...
		<tr>
			...
			<td align="center"><a href="duzenle.php?dersane_id=<?php echo $dersanecek['dersane_id'] ?>"><button>Düzenle</button></td></a>
			<td align="center"><a href="islem.php?dersane_id=<?php echo $dersanecek['dersane_id'] ?>&dersanesil=ok"><button>Sil</button></td></a>
		</tr>
